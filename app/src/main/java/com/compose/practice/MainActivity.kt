...
import com.compose.practice.component.AndroidViewUse
...
import com.compose.practice.container.TopBarUse
    ...
    NavHost(navController = navController, startDestination = "home") {
        ...
        HomeDestination.entries.forEach { destination ->
            ...
            ComponentsDestination.entries.forEach { destination ->
                composable(destination.route) {
                    when (destination) {
                        ComponentsDestination.AndroidViewUse -> AndroidViewUse()
            ...
            ViewContainersDestination.entries.forEach { destination ->
                composable(destination.route) {
                    when (destination) {
                        ...
                        ViewContainersDestination.TopBarUse -> TopBarUse()
                    }}}
        }
    }
}